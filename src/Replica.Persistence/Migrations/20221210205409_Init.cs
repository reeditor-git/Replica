        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_GameZones_GameZoneId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdditionalHose = table.Column<bool>(type: "bit", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hookahs_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HookahId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HookahComponents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HookahComponents_ComponentCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "ComponentCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HookahComponents_Hookahs_HookahId",
                        column: x => x.HookahId,
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "HookahComponents",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HookahComponents_HookahId",
                table: "HookahComponents",
                column: "HookahId");

            migrationBuilder.CreateIndex(
                name: "IX_Hookahs_OrderId",
                table: "Hookahs",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_GameZoneId",
                table: "Orders",
                column: "GameZoneId");
